...
export default function ConstellationGrid() {
  ...
  useEffect(() => {
    ...
    const render = (now) => {
      ...
      // Light theme colors with luxury Gold accent
      const bgColor = '#FBF9F4';
      const nodeColor = '140, 98, 57'; // Warm bronze/taupe
      const accentColor = '212, 175, 55'; // Vibrant Metallic Gold (replaces blue)
      ...
      for (let i = 0; i < nodes.length; i++) {
        ...
        // High-tech Spatial Radar Rings on active proximity in Gold
        if (dist < 90) {
          ...
          // Hex Coordinate Readout in Gold
